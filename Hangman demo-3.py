    ...
    if chance <= 6:
        ...
        try:
            ...
            for repeat in range(no_of_times):
                ...
                button_variable_list[numberic_val].config(state="disable", bg="green", fg="white")
...
def main(frame3=None, frame2=None):
    def frames():
    ...
    billlogin_btn_image_location = os.path.abspath('F:\\College\\College 3rd year\\Project Final year\\Hangman Project\\Out images\\Hangman.png')
    ...
    exitbutton = Button(right_side, text="Exit", bg="peach-puff", relief="groove", font=("century", 9, "bold"), bd=4,
                        width=8, command=exit)
    exitbutton.pack(side="right", ipady=5, padx=15)
    #  FRAME 2
    hangman_imagelocation = os.path.abspath('F:\\College\\College 3rd year\\Project Final year\\Hangman Project\\Out images\\1.png')
