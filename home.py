...
def check(press_button, numberic_val=None, score=None, exitbutton=None, hangman_image_label=None, frame1=None,
          frame2=None, frame3=None):

    global chance, total_score, hangman_image,wrong_click_count,total_click_count,ar_selcted_word

    if chance <= chance:
            no_of_times = letter_into_word.count(press_button)
            total_click_count=total_click_count+1
            if(no_of_times==0):
                wrong_click_count = wrong_click_count + 1
                w=300
                h=300
                hangman_imagelocation = os.path.abspath("images\\"+str(wrong_click_count)+".png")
                ...
                if wrong_click_count>=7:
                    messagebox.showerror("End","Game Over")
            else:
                dd=("leave")
                c = remove_nth(ar_selcted_word, press_button.lower(), 1)
                ar_selcted_word=str(c)
                tmp=0
                for repeat in range(no_of_times):
                    if tmp==0:
                        ...
                        variable.pop(pos)
                        tmp=tmp+1
                win_count=(len(letter_into_word))
                if(win_count==0):
    ...
    # else:
    #         messagebox.showerror("LIMIT EXCEEDED", " you exceed the limit, computer won the game")
    #
    #         score.destroy()
    #         exitbutton.destroy()
    #         hangman_image_label.destroy()
...
def hint_btn():
    global hint_chance
    print("hint_chance"+str(hint_chance))
...
def main():
    ...
    for word in words:
        ...
        ar_letter_into_word.append(word)
    ...
    a_button = Button(frame3, text="A", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=a_btn)
    a_button.grid(row=1, column=0, ipady=5)
    button_variable_list.append(a_button)
    b_button = Button(frame3, text="B", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=b_btn)
    b_button.grid(row=1, column=1, ipady=5)
    button_variable_list.append(b_button)
    c_button = Button(frame3, text="C", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=c_btn)
    c_button.grid(row=1, column=2, ipady=5)
    button_variable_list.append(c_button)
    d_button = Button(frame3, text="D", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=d_btn)
    d_button.grid(row=1, column=3, ipady=5)
    button_variable_list.append(d_button)
    e_button = Button(frame3, text="E", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=e_btn)
    e_button.grid(row=1, column=4, ipady=5)
    button_variable_list.append(e_button)
    f_button = Button(frame3, text="F", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=f_btn)
    f_button.grid(row=1, column=5, ipady=5)
    button_variable_list.append(f_button)
    g_button = Button(frame3, text="G", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=g_btn)
    g_button.grid(row=1, column=6, ipady=5)
    button_variable_list.append(g_button)
    h_button = Button(frame3, text="H", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=h_btn)
    h_button.grid(row=1, column=7, ipady=5)
    button_variable_list.append(h_button)
    i_button = Button(frame3, text="I", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=i_btn)
    i_button.grid(row=1, column=8, ipady=5)
    button_variable_list.append(i_button)
    j_button = Button(frame3, text="J", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=j_btn)
    j_button.grid(row=1, column=9, ipady=5)
    button_variable_list.append(j_button)
    k_button = Button(frame3, text="K", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=k_btn)
    k_button.grid(row=1, column=10, ipady=5)
    button_variable_list.append(k_button)
    l_button = Button(frame3, text="L", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=l_btn)
    l_button.grid(row=1, column=11, ipady=5)
    button_variable_list.append(l_button)
    m_button = Button(frame3, text="M", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=m_btn)
    m_button.grid(row=2, column=1, ipady=5)
    button_variable_list.append(m_button)
    n_button = Button(frame3, text="N", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=n_btn)
    n_button.grid(row=2, column=2, ipady=5)
    button_variable_list.append(n_button)
    o_button = Button(frame3, text="O", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=o_btn)
    o_button.grid(row=2, column=3, ipady=5)
    button_variable_list.append(o_button)
    p_button = Button(frame3, text="P", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=p_btn)
    p_button.grid(row=2, column=4, ipady=5)
    button_variable_list.append(p_button)
    q_button = Button(frame3, text="Q", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=q_btn)
    q_button.grid(row=2, column=5, ipady=5)
    button_variable_list.append(q_button)
    r_button = Button(frame3, text="R", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=r_btn)
    r_button.grid(row=2, column=6, ipady=5)
    button_variable_list.append(r_button)
    s_button = Button(frame3, text="S", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=s_btn)
    s_button.grid(row=2, column=7, ipady=5)
    button_variable_list.append(s_button)
    t_button = Button(frame3, text="T", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=t_btn)
    t_button.grid(row=2, column=8, ipady=5)
    button_variable_list.append(t_button)
    u_button = Button(frame3, text="U", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=u_btn)
    u_button.grid(row=2, column=9, ipady=5)
    button_variable_list.append(u_button)
    v_button = Button(frame3, text="V", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=v_btn)
    v_button.grid(row=3, column=3, ipady=5)
    button_variable_list.append(v_button)
    w_button = Button(frame3, text="W", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=w_btn)
    w_button.grid(row=3, column=4, ipady=5)
    button_variable_list.append(w_button)
    x_button = Button(frame3, text="X", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=x_btn)
    x_button.grid(row=3, column=5, ipady=5)
    button_variable_list.append(x_button)
    y_button = Button(frame3, text="Y", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=y_btn)
    y_button.grid(row=3, column=6, ipady=5)
    button_variable_list.append(y_button)
    z_button = Button(frame3, text="Z", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4, width=8,
                      command=z_btn)
    z_button.grid(row=3, column=7, ipady=5)
    button_variable_list.append(z_button)
    hint_button = Button(frame3, text="Hint", bg="peachpuff", relief="groove", font=("century", 9, "bold"), bd=4,
